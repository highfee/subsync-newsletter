...
const BrandLogin = () => {
  ...
  const onSubmit = () => {
    mutation.mutate({ ...values, isBrand: true });
  };
            ...
            <div className="flex justify-between items-center w-[90%] mt-2">
              <div className="flex items-center">
                <p>
                  ...
                  <span className="text-[#0B0087] font-semibold text-[15px]">
                    {" "}
                    <Link href="/brand/login"> Sign in</Link>
                  </span>{" "}
                </p>
              </div>
              <div>
                <p className="text-[#0B0087] font-semibold text-[15px]">
                  {" "}
                  <Link href="/brand/resetPassword"> </Link>{" "}
                </p>
              </div>
            </div>
